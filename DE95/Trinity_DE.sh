...
nohup align_and_estimate_abundance.pl --transcripts Nicotiana_insilico_ENA_Nano_min800_mod_Jan23.fasta --seqType fq --samples_file All_samples.txt --est_method RSEM --aln_method bowtie2 --thread_count 16 --gene_trans_map Nicotiana_insilico_ENA_Nano_min800.gene_trans_map &  
